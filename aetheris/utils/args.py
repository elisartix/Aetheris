...
import aetheris_tl
import aetheris_tl.extensions
import aetheris_tl.extensions.html
...
def validate_html(html: str) -> str:
    ...
    :return: Valid HTML
    """
    text, entities = aetheris_tl.extensions.html.parse(html)
    return aetheris_tl.extensions.html.unparse(escape_html(text), entities)
