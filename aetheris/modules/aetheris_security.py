...
from aetheris_tl.custom import Message
from aetheris_tl.hints import EntityLike
from aetheris_tl.tl.types import PeerUser, User
...
@loader.tds
class AetherisSecurityMod(loader.Module):
    """Control security settings"""

    strings = {"name": "AetherisSecurity"}
