...
import aetheris_tl
from aetheris_tl.errors.rpcerrorlist import MessageIdInvalidError
from aetheris_tl.sessions import StringSession
from aetheris_tl.tl.types import Message
from meval import meval

from .. import loader, main, utils
from ..log import AetherisException
...
class Evaluator(loader.Module):
    ...
    class _SecureDB:
        ...
        def set(self, *args, **kwargs):
            if len(args) >= 2 and args[0] == "aetheris.security" and args[1] == "owner":
                raise ValueError(
    ...
    async def e(self, message: Message):
        ...
        try:
            ...
            item = AetherisException.from_exc_info(*sys.exc_info())
            print_output = output_print.getvalue()
    ...
    def censor(self, ret: str) -> str:
        ret = ret.replace(str(self._client.aetheris_me.phone), "&lt;phone&gt;")
        ...
        if btoken := self._db.get("aetheris.inline", "bot_token", False):
            ret = ret.replace(
                btoken,
                f'{btoken.split(":")[0]}:{"*" * 26}',
            )
    ...
    async def getattrs(self, message: Message) -> dict:
        ...
        return {
            ...
            "event": message,
            "chat": message.to_id,
            "aetheris_tl": aetheris_tl,
            "telethon": aetheris_tl,
            "hikkatl": aetheris_tl,
            "utils": utils,
            "main": main,
            "loader": loader,
            ...
            "self": self,
            "db": self.db,
            **self.get_sub(aetheris_tl.tl.functions),
            **self.get_sub(aetheris_tl.tl.types),
        }
