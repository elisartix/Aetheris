...
from aetheris_tl.extensions import html
...
class _InlineFormDraft:
    ...
    def __init__(self):
        ...
        self.reply_markup: AetherisReplyMarkup | None = None
...
@loader.tds
class AetherisConfigMod(loader.Module):
    """Interactive configurator for Aetheris Userbot"""

    strings = {"name": "AetherisConfig"}
    ...
    def _category_option(
        ...
        if option in AetherisConfigMod._config_categories(instance).get(category, []):
            return option
