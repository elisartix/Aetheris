...
from aetheris_tl.errors.rpcerrorlist import FloodWaitError, MediaPrevInvalidError
from aetheris_tl.errors.rpcerrorlist import ChatSendInlineForbiddenError
...
class Gallery(InlineUnit):
    async def gallery(
        ...
        *,
        custom_buttons: AetherisReplyMarkup | None = None,
        force_me: bool = False,
        ...
        :param gif: Whether the gallery will be filled with gifs. If you omit this argument and specify
                    gifs in `next_handler`, Aetheris will try to determine the filetype of these images
        :param manual_security: By default, Aetheris will try to inherit inline buttons security from the caller (command)
                                If you want to avoid this, pass `manual_security=True`
        :param disable_security: By default, Aetheris will try to inherit inline buttons security from the caller (command)
