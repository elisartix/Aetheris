        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " Aetheris will try to determine, which client caused logs. E.g. there"
    ...
    async def logs(
        ...
        other = (
            *main.__version__,
            (
                " <a"
                f' href="https://github.com/coddrago/Aetheris/commit/{ghash}">@{ghash[:8]}</a>'
                if ghash
                else ""
            ),
        )
