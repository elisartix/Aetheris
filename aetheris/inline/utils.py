...
from aetheris_tl.errors.rpcbaseerrors import RPCError
...
class Utils(InlineUnit):
    ...
    def _needs_premium_emoji_pre_edit(self, text: typing.Any) -> bool:
        return self._has_premium_emoji(text) and bool(
            getattr(getattr(self._client, "aetheris_me", None), "premium", False)
        )
    ...
    def _generate_markup(
        self: "InlineManager",
        markup_obj: AetherisReplyMarkup | str | None,
    ...
    def _normalize_markup(
        self: "InlineManager", reply_markup: AetherisReplyMarkup
    ...
    def _validate_markup(
        self: "InlineManager",
        buttons: AetherisReplyMarkup | None,
    ) -> list[list[dict[str, typing.Any]]]:
        if buttons is None:
            buttons = []
